...
<div id="qa-management-section">
    ...
    <div id="qa-management-content">
        ...
        $has_qa_files = false;
        $api_display_name = 'Responses API';
        ...
        <?php if (wpiko_chatbot_is_license_active()): ?>
            <p class="description">Manually add, edit, or remove Q&A pairs in the AI Assistant knowledge base. Use this feature to address specific topics, frequently asked questions, or to provide information that may not be present on your website. You can add up to 30 Q&A pairs.</p>
            <div id="qa-management-container">
                ...
                <div class="qa-file-section">
                    ...
                    <p class="description">Your Q&A knowledge base file is automatically synchronized with the AI Assistant. This file contains all your custom Q&A pairs and is used to train your chatbot's responses.</p>
                ...
                <div class="qa-management-view-only">
                    ...
                    <div id="qa-management-container">
                        ...
                        <div class="qa-files-section">
                            ...
                            <p class="description">View your existing Q&A knowledge base files uploaded to the AI Assistant.</p>
                            <ul id="qa-files-list"></ul>
                        </div>
                        <?php endif; ?>
                    </div>
