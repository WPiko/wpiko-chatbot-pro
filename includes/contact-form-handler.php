...
{
    // Increase execution time to prevent timeouts during file uploads or slow SMTP connections
    // Set to 70s to align with JS 60s timeout plus processing buffer
